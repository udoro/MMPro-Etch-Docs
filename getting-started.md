...
The mobile breakpoint defaults to `1201px` (desktop at ≥ 1201 px). To change it, set **Mobile Breakpoint** in the **DWC Nav → Mobile** settings. The value you enter is the last pixel width that is considered *mobile* — e.g. entering `1024` means mobile at ≤ 1024 px and desktop at ≥ 1025 px.
